...
from generated_fastapi_server.models.comments_list_response_data import CommentsListResponseData
try:
...
class CommentsListResponse(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CommentsListResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of CommentsListResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "data": CommentsListResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
