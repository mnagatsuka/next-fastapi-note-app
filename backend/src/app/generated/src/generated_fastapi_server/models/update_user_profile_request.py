...
class UpdateUserProfileRequest(BaseModel):
    ...
    """ # noqa: E501
    display_name: Optional[Annotated[str, Field(strict=True, max_length=60)]] = Field(default=None, alias="displayName")
    email: Optional[StrictStr] = None
    avatar_url: Optional[StrictStr] = Field(default=None, alias="avatarUrl")
    __properties: ClassVar[List[str]] = ["displayName", "email", "avatarUrl"]
