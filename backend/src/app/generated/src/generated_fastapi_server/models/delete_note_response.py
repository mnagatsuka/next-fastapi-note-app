...
from generated_fastapi_server.models.delete_note_response_data import DeleteNoteResponseData
try:
...
class DeleteNoteResponse(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "data": DeleteNoteResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
