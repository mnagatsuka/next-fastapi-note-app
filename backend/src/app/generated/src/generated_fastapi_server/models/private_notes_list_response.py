...
from generated_fastapi_server.models.private_notes_list_response_data import PrivateNotesListResponseData
try:
    from typing import Self
except ImportError:
    from typing_extensions import Self

class PrivateNotesListResponse(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PrivateNotesListResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of PrivateNotesListResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "data": PrivateNotesListResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
