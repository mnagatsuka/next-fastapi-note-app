...
class CommentsListResponseData(BaseModel):
    ...
    """ # noqa: E501
    comments: List[Comment] = Field(description="List of comments for the note")
    ...
    __properties: ClassVar[List[str]] = ["comments", "count", "postId"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CommentsListResponseData from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of CommentsListResponseData from a dict"""
        if obj is None:
            return None
