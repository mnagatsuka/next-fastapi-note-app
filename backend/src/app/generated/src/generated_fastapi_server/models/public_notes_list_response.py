...
from generated_fastapi_server.models.public_notes_list_response_data import PublicNotesListResponseData
try:
    from typing import Self
except ImportError:
    from typing_extensions import Self

class PublicNotesListResponse(BaseModel):
    """
    PublicNotesListResponse
    """ # noqa: E501
    status: StrictStr
    data: PublicNotesListResponseData
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PublicNotesListResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of PublicNotesListResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "data": PublicNotesListResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
