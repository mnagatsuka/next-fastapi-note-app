...
from generated_fastapi_server.models.private_note import PrivateNote
try:
    from typing import Self
except ImportError:
    from typing_extensions import Self

class PrivateNotesListResponseData(BaseModel):
    """
    PrivateNotesListResponseData
    """ # noqa: E501
    notes: List[PrivateNote]
    pagination: Pagination
    __properties: ClassVar[List[str]] = ["notes", "pagination"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PrivateNotesListResponseData from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of PrivateNotesListResponseData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "notes": [PrivateNote.from_dict(_item) for _item in obj.get("notes")] if obj.get("notes") is not None else None,
