...
class AnonymousPromoteRequest(BaseModel):
    """
    AnonymousPromoteRequest
    """ # noqa: E501
    anonymous_firebase_uuid: StrictStr = Field(description="The Firebase UID of the anonymous user to be promoted")
    __properties: ClassVar[List[str]] = ["anonymous_firebase_uuid"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of AnonymousPromoteRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of AnonymousPromoteRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "anonymous_firebase_uuid": obj.get("anonymous_firebase_uuid")
        })
        return _obj
