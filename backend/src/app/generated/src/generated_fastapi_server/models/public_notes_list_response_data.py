...
class PublicNotesListResponseData(BaseModel):
    """
    PublicNotesListResponseData
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PublicNotesListResponseData from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of PublicNotesListResponseData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "notes": [PublicNote.from_dict(_item) for _item in obj.get("notes")] if obj.get("notes") is not None else None,
