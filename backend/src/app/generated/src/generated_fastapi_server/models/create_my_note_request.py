...
class CreateMyNoteRequest(BaseModel):
    ...
    CreateMyNoteRequest
    """ # noqa: E501
    title: Optional[Annotated[str, Field(strict=True, max_length=120)]] = Field(default=None, description="Optional title for the note")
    content: Optional[StrictStr] = Field(default=None, description="Plain text content")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CreateMyNoteRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of CreateMyNoteRequest from a dict"""
        if obj is None:
            return None
