...
class WebsocketTestMessage(BaseModel):
    """
    WebSocket message payload for test messages
    """ # noqa: E501
    message: StrictStr = Field(description="Test message content")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of WebsocketTestMessage from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of WebsocketTestMessage from a dict"""
        if obj is None:
            return None
