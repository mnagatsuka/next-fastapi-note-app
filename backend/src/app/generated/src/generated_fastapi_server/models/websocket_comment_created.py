...
class WebsocketCommentCreated(BaseModel):
    """
    WebSocket message payload for comment creation events
    """ # noqa: E501
    post_id: StrictStr = Field(description="ID of the note the comment was added to", alias="postId")
    comment: Comment
    __properties: ClassVar[List[str]] = ["postId", "comment"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of WebsocketCommentCreated from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of WebsocketCommentCreated from a dict"""
        if obj is None:
            return None
