...
class WebsocketCommentsList(BaseModel):
    """
    WebSocket message payload for comments list updates
    """ # noqa: E501
    post_id: StrictStr = Field(description="ID of the note these comments belong to", alias="postId")
    comments: List[Comment] = Field(description="Complete list of comments for the note")
    count: StrictInt = Field(description="Total number of comments")
    __properties: ClassVar[List[str]] = ["postId", "comments", "count"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of WebsocketCommentsList from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of WebsocketCommentsList from a dict"""
        if obj is None:
            return None
