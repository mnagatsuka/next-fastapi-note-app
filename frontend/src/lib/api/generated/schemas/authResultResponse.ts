import type { AuthResultResponseData } from "./authResultResponseData";
/**
 ...
 */
import type { AuthResultResponseStatus } from "./authResultResponseStatus";

export interface AuthResultResponse {
	status: AuthResultResponseStatus;
