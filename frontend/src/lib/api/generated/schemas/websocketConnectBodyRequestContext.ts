 ...
 */
import type { WebsocketConnectBodyRequestContextRouteKey } from "./websocketConnectBodyRequestContextRouteKey";

export type WebsocketConnectBodyRequestContext = {
	/** WebSocket connection ID */
	connectionId: string;
	routeKey: WebsocketConnectBodyRequestContextRouteKey;
};
