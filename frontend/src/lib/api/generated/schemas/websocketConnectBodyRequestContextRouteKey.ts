...
export type WebsocketConnectBodyRequestContextRouteKey =
	(typeof WebsocketConnectBodyRequestContextRouteKey)[keyof typeof WebsocketConnectBodyRequestContextRouteKey];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const WebsocketConnectBodyRequestContextRouteKey = {
	$connect: "$connect",
} as const;
