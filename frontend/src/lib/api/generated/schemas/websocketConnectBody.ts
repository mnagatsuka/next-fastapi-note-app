 ...
 */
import type { WebsocketConnectBodyRequestContext } from "./websocketConnectBodyRequestContext";

export type WebsocketConnectBody = {
	requestContext: WebsocketConnectBodyRequestContext;
	[key: string]: unknown;
};
