...
export type PrivateNotesListResponseStatus =
	(typeof PrivateNotesListResponseStatus)[keyof typeof PrivateNotesListResponseStatus];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const PrivateNotesListResponseStatus = {
	success: "success",
} as const;
