...
export type PublicNotesListResponseStatus =
	(typeof PublicNotesListResponseStatus)[keyof typeof PublicNotesListResponseStatus];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const PublicNotesListResponseStatus = {
	success: "success",
} as const;
