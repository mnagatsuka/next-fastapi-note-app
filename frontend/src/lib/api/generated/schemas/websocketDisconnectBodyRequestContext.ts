 ...
 */
import type { WebsocketDisconnectBodyRequestContextRouteKey } from "./websocketDisconnectBodyRequestContextRouteKey";

export type WebsocketDisconnectBodyRequestContext = {
	/** WebSocket connection ID */
	connectionId: string;
	routeKey: WebsocketDisconnectBodyRequestContextRouteKey;
};
