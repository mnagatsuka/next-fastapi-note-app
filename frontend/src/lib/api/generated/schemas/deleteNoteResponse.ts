import type { DeleteNoteResponseData } from "./deleteNoteResponseData";
/**
 ...
 */
import type { DeleteNoteResponseStatus } from "./deleteNoteResponseStatus";

export interface DeleteNoteResponse {
	status: DeleteNoteResponseStatus;
