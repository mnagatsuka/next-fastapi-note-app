 ...
 */
import type { WebsocketDisconnectBodyRequestContext } from "./websocketDisconnectBodyRequestContext";

export type WebsocketDisconnectBody = {
	requestContext: WebsocketDisconnectBodyRequestContext;
	[key: string]: unknown;
};
